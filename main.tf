...
module "redes" {
  source = "git::https://github.com/crlealb/terraform-aws-vpc-auy1105-cr.git?ref=v0.1.0"
...
module "computo" {
  source = "git::https://github.com/crlealb/terraform-aws-ec2-auy1105-cr.git?ref=v0.1.0"
...
module "loadbalancer" {
  source = "git::https://github.com/crlealb/terraform-aws-loadbalancer-auy1105-cr.git?ref=v0.1.0"
...
module "storage" {
  source = "git::https://github.com/crlealb/terraform-aws-storage-auy1105-cr.git?ref=v0.1.0"
